...
public class AddPostActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        query.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                for (DataSnapshot dataSnapshot: snapshot.getChildren()){
                    firstName = "" + dataSnapshot.child("firstName").getValue();
        ...
        descriptionEt = findViewById(R.id.pDescriotionEt);
        imageIv = findViewById(R.id.pImageIv);
        uploadBtn = findViewById(R.id.pUploadButton);
        ...
        switch (requestCode){
            ...
            case STORAGE_REQUEST_CODE:{
                if(grantResults.length>0){
                    ...
                    Toast.makeText(this, "Storage both permissions are neccessary....",Toast.LENGTH_SHORT).show();
